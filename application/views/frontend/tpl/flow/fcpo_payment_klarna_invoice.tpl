<dl>
    ...
    <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}]activePayment[{/if}]">
        ...
        <div class="form-group fcpo_klarna_invoice_birthdate">
            <label class="req control-label col-lg-3">[{oxmultilang ident="FCPO_RATEPAY_BIRTHDATE"}]</label>
            <div class="col-lg-9">
                <select name="dynvalue[fcpo_klarna_invoice_birthdate_day]">
                ...
                &nbsp;
                <select name="dynvalue[fcpo_klarna_invoice_birthdate_month]">
                ...
                &nbsp;
                <select name="dynvalue[fcpo_klarna_invoice_birthdate_year]">
            ...
            <div class="alert alert-info col-lg-offset-3 desc">
                <input name="dynvalue[fcpo_klarna_invoice_agreed]" value="agreed" type="checkbox">[{oxmultilang ident="FCPO_KLARNA_DATA_USAGE_AGREE"}]
            </div>
        </div>
